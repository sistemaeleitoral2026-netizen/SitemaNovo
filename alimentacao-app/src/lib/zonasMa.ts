...
export const ZONAS_ELEITORAIS_MA: ZonaEleitoralMA[] = [
  // —— São Luís ——
  // pontos 1:1 com bairros — a mancha (convex hull + heat) usa só estes vértices
  z(1, 'São Luís', ['São Luís'], -2.5297, -44.3028, {
    ...
    pontos: [
      ...
      { lat: -2.5480, lng: -44.3220, nome: 'Vila Bacanga' },
      { lat: -2.5600, lng: -44.3300, nome: 'Vila Embratel' },
      { lat: -2.5520, lng: -44.3120, nome: 'Vila Isabel' },
      { lat: -2.5480, lng: -44.3400, nome: 'Vila Mauro Fecury I' },
      { lat: -2.5620, lng: -44.3080, nome: 'Vila Nova' },
      { lat: -2.5570, lng: -44.3350, nome: 'Vila São Luís' },
    ],
  }),
  ...
  z(3, 'São Luís', ['São Luís'], -2.5100, -44.2700, {
    ...
    pontos: [
      ...
      { lat: -2.5350, lng: -44.2680, nome: 'Angelim Velho' },
      { lat: -2.5150, lng: -44.3000, nome: 'Bequimão' },
      { lat: -2.4950, lng: -44.2550, nome: 'Calhau' },
      { lat: -2.5120, lng: -44.2650, nome: 'Cohafuma' },
      { lat: -2.5580, lng: -44.2750, nome: 'Filipinho' },
      { lat: -2.5050, lng: -44.2680, nome: 'Ipase' },
      { lat: -2.5000, lng: -44.2900, nome: 'Jaracati' },
      { lat: -2.5550, lng: -44.2700, nome: 'João Paulo' },
      { lat: -2.5080, lng: -44.2750, nome: 'Jordoa' },
      { lat: -2.5180, lng: -44.2780, nome: 'Maranhão Novo' },
      { lat: -2.5220, lng: -44.2550, nome: 'Outeiro da Cruz' },
      { lat: -2.5280, lng: -44.2620, nome: 'Radional' },
      { lat: -2.5050, lng: -44.2800, nome: 'Renascença I' },
      { lat: -2.5080, lng: -44.2850, nome: 'Renascença II' },
      { lat: -2.5400, lng: -44.2850, nome: 'Rio Anil' },
      { lat: -2.5500, lng: -44.2550, nome: 'Sacavém' },
      { lat: -2.5320, lng: -44.2750, nome: 'Santa Cruz' },
      { lat: -2.5250, lng: -44.2800, nome: 'Santo Antônio' },
      { lat: -2.4900, lng: -44.2700, nome: 'São Francisco' },
      { lat: -2.5350, lng: -44.2780, nome: 'Vila Lobão' },
  ...
  z(10, 'São Luís', ['São Luís'], -2.5600, -44.2400, {
    ...
    pontos: [
      ...
      { lat: -2.5680, lng: -44.2350, nome: 'Aurora' },
      { lat: -2.5520, lng: -44.2680, nome: 'Cohab Anil III' },
      { lat: -2.5800, lng: -44.2200, nome: 'Coqueiro' },
      { lat: -2.5550, lng: -44.2750, nome: 'Cruzeiro do Anil' },
      { lat: -2.5900, lng: -44.2350, nome: 'Estiva' },
      { lat: -2.5400, lng: -44.2300, nome: 'Forquilha' },
      { lat: -2.5750, lng: -44.2150, nome: 'Inhaúma' },
      { lat: -2.5700, lng: -44.2100, nome: 'Itapera' },
      { lat: -2.5620, lng: -44.2480, nome: 'Jardim São Cristóvão' },
      { lat: -2.5750, lng: -44.2300, nome: 'João de Deus' },
      { lat: -2.5850, lng: -44.2500, nome: 'Maracanã' },
      { lat: -2.5600, lng: -44.2200, nome: 'Pedrinhas' },
      { lat: -2.6050, lng: -44.2450, nome: 'Porto Grande' },
      { lat: -2.5950, lng: -44.2250, nome: 'Quebra-Pote' },
      { lat: -2.6100, lng: -44.2550, nome: 'Rio dos Cachorros' },
      { lat: -2.6000, lng: -44.2400, nome: 'Rio Grande' },
      { lat: -2.5550, lng: -44.2400, nome: 'São Bernardo' },
      { lat: -2.5650, lng: -44.2450, nome: 'São Cristóvão' },
      { lat: -2.6200, lng: -44.2300, nome: 'Tauá-Mirim' },
      { lat: -2.5720, lng: -44.2420, nome: 'Vila Esperança' },
      { lat: -2.5780, lng: -44.2380, nome: 'Vila Itamar' },
      { lat: -2.5950, lng: -44.2600, nome: 'Vila Maranhão' },
      { lat: -2.5880, lng: -44.2280, nome: 'Vila Nova República' },
      { lat: -2.5650, lng: -44.2550, nome: 'Vila Samara' },
      { lat: -2.5820, lng: -44.2550, nome: 'Vila Sarney' },
    ],
  }),
  z(76, 'São Luís', ['São Luís'], -2.5000, -44.2400, {
    ...
    pontos: [
      { lat: -2.4850, lng: -44.2450, nome: 'Barramar' },
      { lat: -2.4900, lng: -44.2500, nome: 'Calhau' },
      { lat: -2.5480, lng: -44.2650, nome: 'Cohab Anil I' },
      { lat: -2.5450, lng: -44.2700, nome: 'Cohab Anil IV' },
      { lat: -2.5120, lng: -44.2250, nome: 'Cohab Turu' },
      { lat: -2.5000, lng: -44.2650, nome: 'Cohajap' },
      { lat: -2.5100, lng: -44.2600, nome: 'Cohama' },
      { lat: -2.5180, lng: -44.2550, nome: 'Cohaserma' },
      { lat: -2.5250, lng: -44.2450, nome: 'Cohatrac' },
      { lat: -2.5280, lng: -44.2380, nome: 'Cohatrac II' },
      { lat: -2.5320, lng: -44.2320, nome: 'Cohatrac III' },
      { lat: -2.5080, lng: -44.2480, nome: 'Divinéia' },
      { lat: -2.5180, lng: -44.2180, nome: 'Habitacional Turu' },
      { lat: -2.5050, lng: -44.2300, nome: "Olho D'Água" },
      { lat: -2.5220, lng: -44.2750, nome: 'Recanto dos Vinhais' },
      { lat: -2.5350, lng: -44.2500, nome: 'Residencial Primavera' },
      { lat: -2.4880, lng: -44.2480, nome: 'Sol e Mar' },
      { lat: -2.5150, lng: -44.2200, nome: 'Turu' },
      { lat: -2.5300, lng: -44.2250, nome: 'Vila Luizão' },
      { lat: -2.4950, lng: -44.2350, nome: 'Vila Vicente Fialho' },
