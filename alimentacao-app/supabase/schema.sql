...
create table if not exists public.cadastros (
  ...
  diretoria_id uuid references public.profiles(id),
  carros_adesivados integer not null default 0,
  adesivos_casa integer not null default 0,
...
-- Ativacao claims (Formigas Pr�ximo) � ver migration 20261003_ativacao_claims.sql
